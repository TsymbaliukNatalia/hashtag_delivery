@section('admin_menu')
    <div class="wrapper">
        ...
        <a class="my-0 mr-md-auto font-weight-normal" href="{{ route('admin') }}"><img src="/img/main_logo.png" alt="company_logo" class="main_logo"></a>
            <button type="button" class="btn btn-primary my-0 mr-md-auto font-weight-normal">Створити посилку
