...
<div id="main_menu" class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 border-bottom">
        <a class="my-0 mr-md-auto font-weight-normal" href="/admin"><img src="/img/main_logo.png" alt="company_logo" class="main_logo"></a>
        <a class="btn btn-primary my-0 mr-md-auto" href="{{ route('new_package') }}" role="button">Створити посилку
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            <a class="btn btn-primary" href="#" role="button">Видати посилку</a>
            ...
            <a class="btn btn-primary" href="/admin/logout" role="button">
                Вийти
