            ...
            <div class="row">
                <div class="col-4 search_package_block">
                    ...
                    <div class="input-group rounded">
                        <input type="search" class="form-control rounded search_package_input" id="search_package" placeholder="Введіть номер посилки" aria-label="Search" aria-describedby="search-addon" />
